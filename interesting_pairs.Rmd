...
outliers_stray <- find_HDoutliers(compare_assoc_steel_wide[,3:6],0.15)
outliers_stray

steel_wide_outliers <- (compare_assoc_steel_wide[,3:6])
steel_wide_outliers$out <- ifelse(outliers_stray$out_scores>0.7,"out","nout")

ggparcoord(steel_wide_outliers,columns = 1:4,groupColumn = "out",scale = "globalminmax")
