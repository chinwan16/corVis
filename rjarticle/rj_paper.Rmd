...
```{r motivation1, fig.width=5, fig.height=6, fig.align='center', fig.cap = "Simulated wave, trapezoid, diamond, quadratic, X, circle and cluster patterns. Each plot shows the value of Pearson's correlation, distance correlation and MIC."}
