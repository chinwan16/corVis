...
Function <- c(rep("calc_assoc",5),rep("association_heatmap",3),rep("pairwise_2d_plot",5),rep("pairwise_1d_compare",4),rep("pairwise_1d_plot",5))

Usage <- c(rep("Calculation",5),rep("Visualization",3),rep("Visualization",4),rep("Visualization",5),rep("Visualization",5))
