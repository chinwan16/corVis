...
```{r assoc-heatmap,fig.width=6, fig.height=6, fig.align='center', fig.cap="Association matrix display for energy consumption data showing Pearson's correlation for numeric variable pairs, canonical correlation for mixed variable pairs and categorical variable pairs.",echo=TRUE}
