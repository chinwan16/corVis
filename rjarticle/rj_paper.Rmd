...
assocMethods <- tribble(
  ...
  "tbl_gkTau", "nominal", "nominal", "DescTools::GoodmanKruskalTau", F, "[0,1]",
...
The `penguins` dataset from the \CRANpkg{palmerpenguins} package has been used to provide illustrative examples. Table \@ref(tab:penguins) provides a brief description of the variables in this dataset.
...
VariableType <- c("nominal","nominal","numerical","numerical","numerical","numerical","nominal","numerical")

df <- data.frame(Variable=Variable,
                 Description=Description,
                 VariableType=VariableType)

kableExtra::kbl(df, booktabs = T, caption = "Variable description of the penguins dataset along with the types of variables")
#print(table_1)
#df %>%
  #kbl() %>%
  #kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
