...
We use Steel Industry Energy consumption dataset providing information on energy consumption by a steel company in South Korea from the [@Dua2019] to provide illustrative examples. Table \@ref(tab:steelindustry) provides a brief description of set of variables from this dataset used for analysis.
...
Variable <- c("Usage_kWh", "LgCRP", "LdCRP", "CO2.tCO2.", "LgCPF", "LdCPF", "NSM",
                          "WeekStatus", "Day_of_week","Load_Type")
