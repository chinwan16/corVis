...
Tukey and Tukey introduced scagnostics which are graph-theoretic
...
the dataset. The packages \CRANpkg{correlationfunnel}
\citep{correlationfunnel} and \CRANpkg{linkspotter} \citep{linkspotter}
look at both the quantitative as well as the qualitative variables
during the correlation analysis. \CRANpkg{correlationfunnel} speeds up
...
and the predictors. On the other hand, \CRANpkg{linkspotter} calculates
...
The package \CRANpkg{corVis} provides a collection of various measures
