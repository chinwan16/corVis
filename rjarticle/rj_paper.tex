...
and conditional association while exploring patterns in a dataset. The
package provides matrix and linear layout for displaying bivariate
association and bivariate association grouped by levels of a categorical
variable, using measures suitable for numerical, ordinal and nominal
variables. With these displays, an analyst can gain a quick overview
about the interesting structure and underlying relationships in the
data. We provide a detailed look at the package functions and discuss
the implemented design choices. We also provide an illustration of the
package on an example dataset.
}
