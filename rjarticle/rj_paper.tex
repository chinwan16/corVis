...
\CRANpkg{zenplots} package which includes numeric variables only.
...
Figure \ref{fig:assoc-matrix-germanelection} shows an association plot
...
Figure \ref{fig:assoc-matrix-cdcdata} shows an association plot for cdc
