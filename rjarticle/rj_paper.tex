...
\caption[Simulated wave, trapezoid, diamond, quadratic, X, circle and cluster patterns]{Simulated wave, trapezoid, diamond, quadratic, X, circle and cluster patterns. Each plot shows the value of Pearson's correlation, distance correlation and MIC.}\label{fig:motivation1}
\end{figure}
\end{Schunk}
...
scatterplots in Figure \ref{fig:motivation1} which show different
simulated patterns such as wave, trapezoid, diamond, quadratic, X,
circle and cluster patterns. Each plot shows the value for Pearson's
correlation, distance correlation and maximal information coefficient by
rho, dcor and MIC respectively. It is evident from Figure
\ref{fig:motivation1} that distance correlation and MIC capture these
patterns quite well as compared to the Pearson's correlation which is
\(0\) for every case and suggests that association measures such as
distance correlation, MIC and other measures should be used along with
Pearson's correlation for exploring relationships among variables.
