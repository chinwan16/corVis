...
a contingency table of two ordinal variables and summarized the
association in \([-1,1]\).

\citet{taha201673} provides an overview of the association measures used
for the nominal and mixed pair of variables.
