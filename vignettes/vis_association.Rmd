...
```{r,fig.width=4, fig.height=4, fig.align='center',fig.cap="Figure 5: Conditional Association plot with Simpson's paradox"}
...
```{r,fig.width=4, fig.height=4, fig.align='center',fig.cap="Figure 6: Conditional Association plot with manual highlighting"}
...
```{r fig.width=4, fig.height=5, fig.align='center', fig.cap="Figure 7: Conditional Association plot using linear layout"}
